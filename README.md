...
```
git clone https://github.com/Sergey-Ivch/foodgram-project-react.git
cd backend
```
...
```
docker build -t username/imagename:version foodgram/.
```
Соберите контейнеры:
```
...
```json
http://51.250.91.182/admin/
http://51.250.91.182/api/docs/
http://51.250.91.182
```
